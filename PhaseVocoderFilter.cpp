...
const tjs_char* TVPInvalidWindowSizeMustBeIn64to32768 = TJS_W("Invalid window size must be in 64 to 32768");
const tjs_char* TVPInvalidOverlapCountMustBeIn2to32 = TJS_W("Invalid overlap count must be in 2 to 32");
const tjs_char* TVPCannotConnectMultipleWaveSoundBufferAtOnce = TJS_W("Cannot connect multiple wave sound buffer at once");

#define TJS_NATIVE_CLASSID_NAME ClassID_PhaseVocoder
static tjs_int32 TJS_NATIVE_CLASSID_NAME = -1;

static iTJSNativeInstance * TJS_INTF_METHOD Create_NI_PhaseVocoder() {
	return new tTJSNI_PhaseVocoder();
}
//---------------------------------------------------------------------------
// tTJSNC_PhaseVocoder : PhaseVocoder TJS native class
//---------------------------------------------------------------------------
iTJSDispatch2 * TVPCreateNativeClass_PhaseVocoder() {
	tTJSNativeClassForPlugin * classobj = TJSCreateNativeClassForPlugin(TJS_W("PhaseVocoder"), Create_NI_PhaseVocoder);
...
//---------------------------------------------------------------------------
tTJSNI_PhaseVocoder::~tTJSNI_PhaseVocoder() noexcept
{
